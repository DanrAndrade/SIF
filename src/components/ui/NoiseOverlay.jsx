...
export default function NoiseOverlay({ opacity = 0.4 }) {
  // Memoizamos o SVG para não ser recriado desnecessariamente
  ...
  return (
    <div 
        className="absolute inset-0 mix-blend-overlay z-0 pointer-events-none"
        style={{ 
